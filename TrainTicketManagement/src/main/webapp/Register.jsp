    ...
    <div class="min-h-screen pt-16 pb-12">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="bg-white rounded-lg shadow-lg p-8">
                ...
                <form action="RegisterServlet" method="post" class="space-y-6" onsubmit="return validateForm()">
                    <!-- User Name -->
                    <div>
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative">
                            ...
                            <textarea id="address" name="address" maxlength="100" required
                                      class="pl-10 w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent"
	     ...
	     <div style="display: flex;">
                    ...
                    <div>
                        <input type="submit"
                                class="w-full bg-blue-600 text-white font-bold py-3 px-6 rounded-lg hover:bg-blue-700 transition duration-300" value="Register">
                    ...
                    <div class="text-center">
                        <p class="text-gray-600">
                            ...
                            <a href="login.jsp" class="text-blue-600 hover:text-blue-800 font-semibold">Login here</a>
                        </p>
                    </div>
                </form>
            </div>
