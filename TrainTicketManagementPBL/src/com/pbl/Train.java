...
public class Train {
    ...
    public Train(int trainNumber, String trainName, String originStation, String destinationStation,
			String departureTime, String arrivalTime, int numberOfSeats, int firstac, int secondac, int thirdac,
			int secondsitting, int sleeper, Date traindate) {
		super();
	...
	public String toString() {
		return "Train [trainNumber=" + trainNumber + ", trainName=" + trainName + ", originStation=" + originStation
				...
				+ arrivalTime + ", numberOfSeats=" + numberOfSeats + ", firstac=" + firstac + ", secondac=" + secondac
				+ ", thirdac=" + thirdac + ", secondsitting=" + secondsitting + ", sleeper=" + sleeper + ", traindate="
				+ traindate + "]";
	}
